...
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/lockett.png")
```
...
```{r, echo = FALSE, out.width = "550px"}
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/hex_college.png")
```
...
```{r, echo = FALSE, out.width = "550px"}
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/ggimage.png")
```
...
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/drive_sim.png")
```
...
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/kc_ne.gif")
```
...
```{r, echo = FALSE, out.width = "500px"}
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/no_pit.gif")
```
...
```{r, echo = FALSE, out.width = "500px"}
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/passes_mahomes.gif")
```
...
```{r, echo = FALSE, out.width = "500px"}
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/bell.png")
```
...
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/burris.gif")
```
...
knitr::include_graphics("/Users/mlopez1/Dropbox/NFL_Random_Pats/sfu.png")
```