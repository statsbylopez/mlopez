...
[Brian](https://twitter.com/bburkeESPN/status/1055150920340774912), [Alex](https://twitter.com/abresler/status/1055446174730240000), and a host of others have done nice work recently when it comes to creating better scatter plots using [R](https://cran.r-project.org/). In this post, I'll show how easy it is to use the `ggimage` package and do the same.
...
Same chart as we initially had, and one-less line of code. 
