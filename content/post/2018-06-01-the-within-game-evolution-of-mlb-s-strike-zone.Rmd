...
In any case, for now, we note that MLB umpires tend to call higher rates of strikes late in games when one team has a lead. This is potentially in an effort to speed up the game, and cannot be fully explained by a preference for star releif pitchers. 
